          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3">
                <label className="cursor-pointer px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                {localSettings.logoUrl && (
                  <button 
                    onClick={removeLogo}
                    className="px-4 py-2 bg-white border border-red-200 text-red-600 rounded-md shadow-sm text-sm font-medium hover:bg-red-50 transition-colors"
                  >
                    Remove
                  </button>
                )}
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-sandpix-500 transition-shadow"
              />
            </div>
            <div>
